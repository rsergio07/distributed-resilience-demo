...
# ============================================================
# Agentic AI-Driven Scaling Demo - OFFLINE Deploy
# ============================================================
...
# 4) Apply manifests for AI agent demo
info "Applying Kubernetes manifests for AI agent demo"
kubectl apply -f k8s/namespace.yaml
kubectl -n "${NAMESPACE}" apply -f k8s/deployment-blue.yaml
kubectl -n "${NAMESPACE}" apply -f k8s/deployment-green.yaml
# Only deploy HPA for the green deployment
...
info "Cluster ready for AI agent demo."