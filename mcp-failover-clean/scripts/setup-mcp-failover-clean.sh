...
echo ""
echo "🔧 Test commands:"
echo "   minikube service web -n mcp-failover-clean --url"
echo "   kubectl scale deployment web-green --replicas=2 -n mcp-failover-clean"
echo "   kubectl get pods -n mcp-failover-clean"
